            ...
            value: function _setLogic(args, method) {
                ...
                if (this._mode == 'interval') {
                    if (method == 'fetch') {
                        ...
                        feedObject._clearID = setTimeout(function () {
                            _this._doFetch(feedObject);
                        }, feedObject._refreshRate);
                    } else {
                        this._doFetch(feedObject);
                        feedObject._clearMode = 'interval';
                        feedObject._clearID = setInterval(function () {
                            _this._doFetch(feedObject);
                        }, feedObject._refreshRate);
                    }
                }
